...
class VocabEntry(object):
    ...
    def words2charindices(self, sents):
        ...
        word_ids = [[ [self.start_of_word] + [self.char2id[char] for char in word] + [self.end_of_word] for word in sent] for sent in sents]
        return word_ids
        ### END YOUR CODE
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        ###     previous parts
        #sents has shape(sent_length, batch_size)
